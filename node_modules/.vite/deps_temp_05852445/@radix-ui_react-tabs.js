...
var Slot2 = React17.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime8.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime8.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React17.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React17.isValidElement(child) && child.type === Slottable2;
}
...
var DirectionContext2 = React19.createContext(void 0);
function useDirection2(localDir) {
  const globalDir = React19.useContext(DirectionContext2);
  return localDir || globalDir || "ltr";
}
